...
namespace HotelBookingSystem.Application.Services.CardServices
{
    ...
    public class CardService : ICardService
    {
        ...
        public CardService(ICardRepository cardRepository, IMapper mapper, IValidator<CreateCardDto> createCardDtoValidator)
        {
        ...
        public async Task<long> CreateCardAsync(CreateCardDto createCardDto)
        {
            ...
            var existingCards = await _cardRepository.SelectSelectedCardByUserIdAsync(createCardDto.UserId);
            ...
            return await _cardRepository.InsertAsync(cardEntity);
        }
